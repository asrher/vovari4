...
exports.getTime = (format, date) => {
	if (date) {
		...
		return moment.tz('Asia/Riyadh').locale('id').format(format)
	}
}
...
exports.smsg = (conn, citel, store) => {
  ...
  citel.send =  async (content,opt = { packname: "BK9💙" }, type = "text")  => {
...
//=====================================================================----
  ...
  citel.reply = async (content,opt = { packname: "BK9💙", author: "BK9💙" }, type = "text")  => {
