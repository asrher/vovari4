...
module.exports = {
  ...
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'B K 9 💙' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'B K 9 💙' : process.env.PACK_INFO.split(";")[1],
