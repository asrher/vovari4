...
cmd({
  ...
  if(!deathGame || !deathGame[id]){
    ...
    word :null,
    chosenWord: "",
    words: ['ناروتو', 'ناروت', 'نارو', 'نار',"موساشي","موسا","موساش","مو"], 
    }
  }
  ...
  if(citel.text.toLowerCase() === "بدخل" && deathGame[id] && deathGame[id].join &&  !deathGame[id].available.includes(citel.sender)){
  ...
  async function startTimer(m,id="suhail", durationInSeconds=3 , type = "بدخل",pplyers = "1,2") {
